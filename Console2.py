...
def ui_adauga_obiect_2(ID, nume, descriere, pret_achizitie, locatie , lista, undo_list):
    try:
...
def ui_sterge_obiect_2(ID, lista, undo_list):
    try:
...
def ui_modifica_obiect_2(ID, nume, descriere, pret_achizitie, locatie, lista, undo_list):
    try:
...
def ui_mutare_obiect_locatie_2(ID, locatie, lista, undo_list):
    undo_list.append(lista)
    return mutare_obiect_locatie(lista, ID, locatie)


def ui_concatenare_2(string,pret,lista, undo_list):
    try:
...
def ui_ordonare_crescator_pret_2(lista, undo_list):
    undo_list.append(lista)
        ...
        if cerinta == "stop":
            ...
            for c in lista_cerinte:
                if c == "help":
                    ...
                    locatie = c.split(",")[5]
                    lista = ui_adauga_obiect_2(ID, nume, descriere, pret_achizitie, locatie, lista, undo_list)
                elif c[0:4] == "show":
                    show_all(lista)
                elif c[0:6] == "delete":
                    ID = c.split(",")[1]
                    lista = ui_sterge_obiect_2(ID, lista, undo_list)
                elif c[0:6] == "modify":
                    ID = c.split(",")[1]
                    nume = c.split(",")[2]
                    descriere = c.split(",")[3]
                    pret_achizitie = float(c.split(",")[4])
                    locatie = c.split(",")[5]
                    lista = ui_modifica_obiect_2(ID, nume, descriere, pret_achizitie, locatie, lista, undo_list)
                elif c[0]=="4":
                    ID = c.split(",")[1]
                    locatie = c.split(",")[2]
                    ui_mutare_obiect_locatie_2(ID, locatie, lista, undo_list)
                elif c[0]=="5":
                    string = c.split(",")[1]
                    pret = float(c.split(",")[2])
                    ui_concatenare_2(string, pret, lista, undo_list)
                elif c[0]=="6":
                    ui_pret_max_locatie(lista)
                elif c[0]=="7":
                    lista=ui_ordonare_crescator_pret_2(lista, undo_list)
                elif c[0]=="8":
